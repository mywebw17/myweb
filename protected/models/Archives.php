...
class Archives extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('tags, urlgambar', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, title, content, tags, status, create_time, update_time, author_id, urlgambar', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('urlgambar',$this->urlgambar,true);
